...
public class NearbyWords implements SpellingSuggest {
	...
	public void substitution(String s, List<String> currentList, boolean wordsOnly) {
		...
		for(int index = 0; index < s.length(); index++){
			for(int charCode = (int)'a'; charCode <= (int)'z'; charCode++) {
				...
				addWordToList(s, currentList, wordsOnly, sb);
			}
		}
	}
	...
	public void insertions(String s, List<String> currentList, boolean wordsOnly ) {
		...
		// for each character in the String s, right before it, insert a letter (a-z)
		for(int index = 0; index < s.length(); index++){
			for(int charCode = (int)'a'; charCode <= (int)'z'; charCode++) {
				StringBuffer sb = new StringBuffer(s);
			...
			// if last character, then insert one after it as well (a-z)
			if (index == s.length()-1) {
				for(int charCode = (int)'a'; charCode <= (int)'z'; charCode++) {
					StringBuffer sb = new StringBuffer(s);
	...
	/** if the item isn't in the list, isn't the original string, and
	  ...
	  */
	private void addWordToList(String s, List<String> currentList, boolean wordsOnly,StringBuffer sb) {
